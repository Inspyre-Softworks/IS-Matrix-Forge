"""Public package surface for the LED matrix helpers.

Keep this module light: no hardware access at import time.
"""

from __future__ import annotations

from is_matrix_forge.common.preset_config import check_and_prompt_presets
...
def __getattr__(name: str):
    ...
    if name == "scroll_text_on_multiple_matrices":
        ...
        globals()["scroll_text_on_multiple_matrices"] = (
            scroll_text_on_multiple_matrices
        )
