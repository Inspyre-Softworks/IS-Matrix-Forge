...
## Summary
IS Matrix Forge is a Python framework for creating applications that drive 9×34 LED matrix displays. It provides high-level helpers for communicating with the hardware, tools for building animations, and utilities such as progress bars.
